...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 23, 2022 at 01:49 AM
...
(1,'2022-06-22 04:54:35', 'Maajun Nenda', 'Maajun-nenda-satu', 'DSC05144-1-510x1024.png', 50, 'Produk ini untuk perempuan.'),
(2, '2022-06-22 04:55:54', 'Maajun Ayahanda', 'Maajun-ayahanda-satu', 'Ayahanda-2 (1).png', 50, 'Produk ini untuk kegunaan lelaki.'),
(3, '2022-06-22 04:57:15', 'Maajun Nenda Combo', 'Maajun-nenda-combo', 'Nenda-01-1-863x1024.png', 100, 'Produk ini untuk kegunaan perempuan.'),
(4,'2022-06-22 04:57:58', 'Maajun Ayahanda Combo', 'Maajun-ayahanda-combo', 'Ayah-2-01-863x1024.png', 100, 'Produk ini untuk kegunaan lelaki.'),
(5,  '2022-06-22 04:59:10', 'Maajun Nenda & Ayahanda', 'Maajun-nenda-ayahanda', 'Nenda-ayah-01-863x1024.png', 100, 'Produk ini untuk kegunaan combo perempuan dan lelaki'),
(6, '2022-06-22 05:01:04', 'Maajun Nenda 3X Combo', 'Maajun-nenda-3X-COMBO', 'nenda-3-01-997x1024.png', 150, 'Produk ini untuk kegunaan wanita.'),
(7, '2022-06-22 05:02:10', 'Maajun Nenda 4X Combo', 'Maajun-nenda-4x-combo', 'nenda-4-01-1024x909.png', 200, 'Produk ini untuk kegunaan wanita.');
...
CREATE TABLE `wishlist` (
  `wishlist_id` int(10) NOT NULL AUTOINCREMENT PRIMARY KEY,
  `customer_id` int(10) NOT NULL,
